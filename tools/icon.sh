...
DISCOVER_WEB_DIR=$PROJECT_DIR/apps/discover/public
...
sips -z 16 16   $SRC_PNG --out $DISCOVER_WEB_DIR/logo-16x16.png
sips -z 64 64   $SRC_PNG --out $DISCOVER_WEB_DIR/logo-64x64.png
sips -z 128 128   $SRC_PNG --out $DISCOVER_WEB_DIR/logo-128x128.png
sips -z 256 256   $SRC_PNG --out $DISCOVER_WEB_DIR/coin-256x256.png

sips -z 32 32   $SRC_PNG --out $DISCOVER_WEB_DIR/favicon.png
